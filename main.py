#!/usr/bin/env python3
# main.py - MZKYZAK OTP Spammer System
...
def show_buy_guide():
    ...
    print(f"  {Fore.GREEN}•{Style.RESET_ALL} Mendapat update MZKYZAK System terbaru")
    print(f"  {Fore.GREEN}•{Style.RESET_ALL} Mendapat API baru jika ditambahkan")
    print(f"  {Fore.GREEN}•{Style.RESET_ALL} Dukungan prioritas dari MZKYZAK Support")
    print()
    ...
    print(f"  1. Chat MZKYZAK Support via WhatsApp atau Telegram")
    print(f"  2. Kirim Device ID Anda")
    print(f"  3. Lakukan pembayaran via QRIS (akan diberikan MZKYZAK Support)")
    print(f"  4. Tunggu aktivasi")
    print()
    print(f"{Fore.CYAN}Kontak MZKYZAK Support:{Style.RESET_ALL}")
